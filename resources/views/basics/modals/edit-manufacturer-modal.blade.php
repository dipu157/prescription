<div class="modal fade right" id="modal-edit-manufacturer" tabindex="-1" role="dialog" aria-labelledby="modal-edit-manufacturer-label"
        ...
        <form action="#" method="post" accept-charset="utf-8">
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color: rgba(28,212,238,0.14);">
                    <p class="heading">Edit Manufacturer Info</p>
                ...
                <div class="modal-footer justify-content-center">
                    <button type="submit" class="btn btn-primary btn-edit-manufacturer">Save</button>
