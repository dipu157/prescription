                        ...
                        <div class="row">
                            <div class="container-fluid">
                                ...
                                <table class="table table-striped" id="report">
                                    ...
                                    {{--<tr>--}}
                                    {{--<td width="5%" style="font-size:12pt; color:black; "><strong>Diagnosis</strong></td>--}}
                                    {{--<td width="3%" style="font-size:12pt; color:black; "><strong>:</strong></td>--}}
                                    {{--<td colspan="10" width="90%" style="font-size:12pt; color:black; text-align: left ">{!! nl2br(e($prescription->diagnosis)) !!}</td>--}}

                                    {{--</tr>--}}

                                    {{--<tr>--}}
                                    {{--<td width="5%" style="font-size:12pt; color:black; "><strong>Current <br> Status</strong></td>--}}
                                    {{--<td width="3%" style="font-size:12pt; color:black; "><strong>:</strong></td>--}}
                                    {{--<td colspan="10" width="90%" style="font-size:12pt; color:black; text-align: left ">{!! $prescription->complains  !!}</td>--}}
                                    {{--</tr>--}}
                                ...
                                <div style="float:left;width:30%;border-right:1px solid #e4e5e7;padding-right:10px">
                                    ...
                                    <table class="table table-striped" width="25%">
                                        ...
                                        {{--<tr style="width: 100%">--}}
                                        {{--<td width="10%" style="font-size:12pt; color:black; "><strong>Chief <br> Complaints</strong></td>--}}
                                        {{--<td width="5%" style="font-size:12pt; color:black; "><strong>:</strong></td>--}}
                                        {{--<td width="50%" style="font-size:12pt; color:black; "><strong>{!! $prescription->complains !!}</strong></td>--}}
                                        {{--</tr>--}}
                                        ...
                                        {{--<tr style="width: 100%">--}}
                                        {{--<td width="10%" style="font-size:12pt; color:black; "><strong>O2Sat</strong></td>--}}
                                        {{--<td width="5%" style="font-size:12pt; color:black; "><strong>:</strong></td>--}}
                                        {{--<td width="50%" style="font-size:12pt; color:black; "><strong>{!! $prescription->o2sat !!}</strong></td>--}}
                                        {{--</tr>--}}
                                        ...
                                        {{--<tr style="width: 100%">--}}
                                        {{--<td colspan="3" width="75%" style="font-size:12pt; color:black; "><strong><u>Advice</u></strong></td>--}}
                                        {{--</tr>--}}

                                        {{--@foreach($prescription->gadvice as $i=>$advs)--}}
                                        {{--<tr>--}}

                                        {{--<td colspan="3" width="75%" style="font-size:12pt; color:black; ">{!! $advs->advice !!}</td>--}}
                                        ...
                                        {{--<tr style="width: 100%">--}}
                                        {{--<td colspan="3" width="75%" style="font-size:12pt; color:black; "><strong>{!! $prescription->remarks !!}</strong></td>--}}
                                        {{--</tr>--}}
